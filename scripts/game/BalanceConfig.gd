...
const PRESTIGE_DAMAGE_TALENT_BONUS_PERCENT_PER_LEVEL: int = 25
const PRESTIGE_GOLD_TALENT_BONUS_PERCENT_PER_LEVEL: int = 50
const PRESTIGE_UTILITY_TALENT_BONUS_PERCENT_PER_LEVEL: int = 5

...
const SETTLEMENT_COUNT_FONT_SIZE: int = 18
const SETTLEMENT_PURCHASE_GAIN_FONT_SIZE: int = 18
const SETTLEMENT_TOTAL_BONUS_FONT_SIZE: int = 18
const SETTLEMENT_MILESTONE_FONT_SIZE: int = 15
const SETTLEMENT_BUTTON_FONT_SIZE: int = 18

# Prestige talent cards
const PRESTIGE_NAME_FONT_SIZE: int = 22
const PRESTIGE_COUNT_FONT_SIZE: int = 18
const PRESTIGE_PURCHASE_GAIN_FONT_SIZE: int = 18
const PRESTIGE_TOTAL_BONUS_FONT_SIZE: int = 18
const PRESTIGE_EMPTY_ROW_FONT_SIZE: int = 15
const PRESTIGE_BUTTON_FONT_SIZE: int = 18

# Prestige action card
const PRESTIGE_ACTION_TITLE_FONT_SIZE: int = 22
const PRESTIGE_ACTION_REWARD_FONT_SIZE: int = 18
const PRESTIGE_ACTION_RESET_FONT_SIZE: int = 18
const PRESTIGE_ACTION_GET_POINTS_FONT_SIZE: int = 18
const PRESTIGE_ACTION_BUTTON_FONT_SIZE: int = 18
